"""
Tournament points-table simulation: builds the actual and predicted 2026
points tables (wins, losses, NRR) from match results, and compares them.

Ported from project_gagan's original pipeline source, cells 60-64.
"""
