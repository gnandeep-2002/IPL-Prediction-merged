"""
convert_to_excel.py
Converts all Cricsheet IPL JSON files into a single structured Excel file
with two sheets:
  - Ball by Ball : one row per delivery (295k rows)
  - Match Info   : one row per match (metadata summary)
"""
...
# Sort by date then innings then over then ball
